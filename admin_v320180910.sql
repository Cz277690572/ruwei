...
-- ----------------------------
INSERT INTO `shop_goods` VALUES (1, 2, 1, '猪扒饭', '<p>内容</p>\r\n', 'http://ruwei.com/static/upload/cb3f32cb706c0325/c1c1afa9b2c5e9a3.jpg', 'http://ruwei.com/static/upload/e844d00fd27f83c9/4e697265a63b9971.jpg', '描述', 12.50, 20, 19, 1, 0, 1, 0, '2018-08-02 16:20:08');
INSERT INTO `shop_goods` VALUES (2, 2, 3, '龟苓膏（芦苇）', '<p>内容</p>\r\n', 'http://ruwei.com/static/upload/3837304710d6af3d/9704596f307eb1e7.jpg', 'http://ruwei.com/static/upload/1d5e9a1f4a375937/c28e7c2167c32812.jpg|http://ruwei.com/static/upload/130dae9e132c4275/cec56df6b54e134b.jpg', '展示', 10.00, 100, 98, 2, 0, 1, 0, '2018-08-06 10:16:33');
...
CREATE TABLE `shop_goods_stock`  (
  ...
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 48 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店商品库存' ROW_FORMAT = Compact;
...
INSERT INTO `shop_goods_stock` VALUES (46, 1, 2, '9/3', 0, 1, 0, '2018-09-03 09:42:50');
INSERT INTO `shop_goods_stock` VALUES (47, 1, 7, '', 0, 1, 0, '2018-09-04 15:00:14');
...
-- ----------------------------
INSERT INTO `shop_location` VALUES (1, 2, '门店2', '门店2联系人', '18476420222', 1.00, 10, NULL, NULL, '广东省', '深圳市', '南山区', '新安技术学校', 'http://ruwei.com/static/upload/aaa5b9b9f37a50d0/217789d24f1dfe23.jpg', 'http://ruwei.com/static/upload/cb3f32cb706c0325/c1c1afa9b2c5e9a3.jpg|http://ruwei.com/static/upload/45cf3bf593cee293/ad8683260472eb5e.jpg', '营业时间10:30-13:30 | 16:30-18:30', '', 0, 1, 0, '2018-08-01 17:55:04');
INSERT INTO `shop_location` VALUES (2, 3, '门店3', '门店3联系人', '18476420333', 1.00, 10, NULL, NULL, '广东省', '珠海市', '金湾区', '珠海市城市职业技术学校', 'http://ruwei.com/static/upload/ff7035667a648714/3d49273f3013587d.jpg', 'http://ruwei.com/static/upload/f0df1cee65b466d6/daf6165e0e127697.jpg|http://ruwei.com/static/upload/236eb146d6cef559/3f75ad166fdb6890.jpg', '营业时间10:30-13:30 | 16:30-18:30', '', 0, 1, 0, '2018-08-01 17:58:26');
INSERT INTO `shop_location` VALUES (4, 4, '门店4', '门店4联系人', '18476420444', 10.00, 11, NULL, NULL, '广东省', '深圳市', '南山区', '欧洲城东', 'http://ruwei.com/static/upload/236eb146d6cef559/3f75ad166fdb6890.jpg', 'http://ruwei.com/static/upload/ee762d7ffdb92ffa/83d7578aafa23a1c.jpg|http://ruwei.com/static/upload/1d5e9a1f4a375937/c28e7c2167c32812.jpg|http://ruwei.com/static/upload/130dae9e132c4275/cec56df6b54e134b.jpg|http://ruwei.com/static/upload/6915fa913bb95279/80d6d1e14074778d.jpg|http://ruwei.com/static/upload/f0df1cee65b466d6/daf6165e0e127697.jpg', '营业时间11:00-13:30', '', 0, 1, 0, '2018-08-30 11:30:07');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店订单主表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of shop_order
-- ----------------------------
INSERT INTO `shop_order` VALUES (19, 2, 1, 'A9035757820000878', '龟苓膏（芦苇）等', 'http://ruwei.com/static/upload/3837304710d6af3d/9704596f307eb1e7.jpg', 0.00, 32.50, 3, 32.50, 0, 'wechat微信支付', '', 32.50, NULL, '不要加辣', 1, 0, '2018-09-03 14:52:58');
...
CREATE TABLE `shop_order_express`  (
  ...
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店订单配送信息' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of shop_order_express
-- ----------------------------
INSERT INTO `shop_order_express` VALUES (19, 2, 1, 0, 19, 'A9035757820000878', '阿猫', '15220501265', '广东省', '深圳市', '南山区', '2栋622', '门店3联系人', '18476420333', '广东省', '珠海市', '金湾区', '珠海市城市职业技术学校', NULL, NULL, 1, 0, '2018-09-03 14:52:58');
...
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店订单关联商品' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of shop_order_goods
-- ----------------------------
INSERT INTO `shop_order_goods` VALUES (37, 2, 1, 19, 'A9035757820000878', 2, '龟苓膏（芦苇）', 'http://ruwei.com/static/upload/3837304710d6af3d/9704596f307eb1e7.jpg', NULL, 10.00, 'selling_price', 2, 1, 0, '2018-09-03 14:52:58');
INSERT INTO `shop_order_goods` VALUES (38, 2, 1, 19, 'A9035757820000878', 1, '猪扒饭', 'http://ruwei.com/static/upload/cb3f32cb706c0325/c1c1afa9b2c5e9a3.jpg', NULL, 12.50, 'selling_price', 1, 1, 0, '2018-09-03 14:52:58');

-- ----------------------------
-- Table structure for shop_order_stock
-- ----------------------------
DROP TABLE IF EXISTS `shop_order_stock`;
CREATE TABLE `shop_order_stock`  (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '订单ID',
  `order_no` char(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '订单编号',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '描述',
  `sort` bigint(20) UNSIGNED NULL DEFAULT 0 COMMENT '数据排序',
  `status` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '状态(1有效,0无效)',
  `is_deleted` tinyint(1) UNSIGNED NULL DEFAULT 0 COMMENT '删除状态(1删除,0未删除)',
  `create_at` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '门店订单库存异常记录' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of shop_order_stock
-- ----------------------------
INSERT INTO `shop_order_stock` VALUES (1, 19, 'A9035757820000878', '订单已支付，但是库存不足!', 0, 1, 0, '2018-09-04 15:01:33');
...
CREATE TABLE `system_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统操作日志表' ROW_FORMAT = Compact;
...
INSERT INTO `system_log` VALUES (38, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-03 09:00:32');
INSERT INTO `system_log` VALUES (39, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-04 09:03:21');
INSERT INTO `system_log` VALUES (40, '127.0.0.1', 'admin/login/out', 'admin', '系统管理', '用户退出系统成功', '2018-09-04 12:00:56');
INSERT INTO `system_log` VALUES (41, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-04 12:01:00');
INSERT INTO `system_log` VALUES (42, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-05 18:53:25');
INSERT INTO `system_log` VALUES (43, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-06 09:39:27');
INSERT INTO `system_log` VALUES (44, '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2018-09-10 15:32:26');
...
-- ----------------------------
INSERT INTO `system_user` VALUES (10000, 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', '', '', '', 23003, '2018-09-10 15:32:26', 1, '2,4', 0, NULL, '2015-11-13 15:14:22');
